...
author: "Aaron Null"
date: "2023-06-22"
categories: ["Week Six", "Grocery Team"]
---

![Lunchtime at Grundy Center.](images/lunchtime.jpg){width="545"}
...
![A house that would be marked as "good".](images/housegood.png){width="505"}

![A house that would be marked as being in "poor" condition.](images/housepoor.png){width="508"}
...
![Percentages for categories of expenses/income across revenue ranges/store sizes (Bizminer)](images/percentages_blog-01.png)
...
![Revenue vs. Expense](images/revenue_and_expense-02.png){width="597"}
...
![Slider input example (Shiny)](images/slider_input-01.png)
...
![](images/unnamed-chunk-2-1.png){width="633"}
...
![](images/dollarstoremailingcity.png){width="618"}
...
![](images/dollarstoregoogle.png){width="661"}
...
![](images/chaingrocerylocation.png){width="541"}

![](images/nonchaingrocerylocation.png){width="554"}
...
![](images/sales_volume_for_chain_grocery.png){width="675"}
...
![](images/sales_volume_for_non_chain_grocery.png){width="643"}
